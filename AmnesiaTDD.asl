...
{
	byte 	 	loading1	: 0x75A120, 0x84, 0x7C, 0x04;
	byte 	 	loading2	: 0x75A120, 0x84, 0x7C;
	
	string32 	audio		: 0x75A108, 0x48, 0x38, 0x04, 0x08, 0x04, 0x00;
	string15	audio2		: 0x75A108, 0x48, 0x38, 0x04, 0x08, 0x04;
	string24 	map 		: 0x741A34, 0x94, 0x60, 0x38;
	bool 	 	pActive		: 0x741A34, 0xBC, 0x58;
	float 	 	pMSMul		: 0x741A34, 0xBC, 0xD4;
	float		pPosX		: 0x741A34, 0xBC, 0x54, 0x48;
}

state("Amnesia_NoSteam","NoSteam 1.5")
{
	byte 	 	loading1	: 0x754CF0, 0x84, 0x7C, 0x04;
	byte 	 	loading2	: 0x754CF0, 0x84, 0x7C;
	
	string32 	audio		: 0x754CD8, 0x48, 0x38, 0x04, 0x08, 0x04, 0x00;
	string15	audio2		: 0x754CD8, 0x48, 0x38, 0x04, 0x08, 0x04;
	string24 	map 		: 0x73C604, 0x94, 0x60, 0x38;
	bool 	 	pActive		: 0x73C604, 0xBC, 0x58;
	float 	 	pMSMul		: 0x73C604, 0xBC, 0xD4;
	float		pPosX		: 0x73C604, 0xBC, 0x54, 0x48;
}
